...
public class Supplier {
	...
	/**
	 * This method returns a string filled with the suppliers details
	 * @return - The suppliers details in string format
	 */
	public String supplierDetails() {
		String supplierDetails = "Supplier Code: " + this.supCode
				+ "\nSupplier Name: " + this.getSupName()
				+ "\n" + this.getSupAddress().getFullAddress()
				+ "\nSupplier Region: " + this.getSupRegion().getRegionAsString();
