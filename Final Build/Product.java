...
public class Product {
	...
	/**
	 * Returns the all the details for a given product object instance but indented
	 * @return - Product details in string format but indented
	 */
	public String getProductDetailsIndented() {
		String productDetails = "Product Code: " + proCode
				+ "\n\tProduct Make: " + proMake
				+ "\n\tProduct Model: " + proModel
				+ "\n\tProduct Price:" + String.format("£%.2f",proPrice)
	...
	/**
	 * This method adds the integer input to the products quantity
	 * @param quantity - The quantity to be added 
	 */
	public void addQuantity (int quantity) {
		this.proQtyAvailable += quantity;
	}
