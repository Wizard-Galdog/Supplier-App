...
public class TesterObjects {
	...
	private static Supplier createSupplierTester1() {
		...
		Product productTester2 = new Product(17750, "Samsung", "Galaxy J3", 149.99, true);
		Product productTester3 = new Product(18265, "Samsung", "Galaxy J5", 239.99, true);
		Product productTester4 = new Product(21659, "Samsung", "Galaxy Note8", 869.00, true);
		 ...
		 */
		productTester1.setProQtyAvailable(4);
